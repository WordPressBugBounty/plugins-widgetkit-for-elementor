...
class WK_PRO_FEATURES
{
    ...
    public static function register_text_animation_controls($element)
    {
        $element->start_controls_section(
            ...
            [
                'label' => sprintf('<i class="wk-logo"></i> %s <span class="wkpro_text">%s<span>', __('Text Animation', 'widgetkit-for-elementor'), __('WK', 'widgetkit-for-elementor')),
            ]
        );
    ...
    public static function register_image_animation_controls($element)
    {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => sprintf('<i class="wk-logo"></i> %s <span class="wkpro_text">%s<span>', __('Image Animation', 'widgetkit-for-elementor'), __('WK', 'widgetkit-for-elementor')),
            ]
        );
