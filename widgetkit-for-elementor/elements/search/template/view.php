...
?>
    ...
    <div class="wkfe-search">
        <div id="wkfe-search-<?php echo esc_attr($this->get_id()); ?>" class="wkfe-search-wrapper wkfe-search-<?php echo esc_attr($this->get_id()); ?>">
            ...
            <div class="<?php echo esc_attr($search_icon_alignment); ?> wkfe-search-form-wrapper" style="display:none;">
                <form action="<?php echo esc_attr(home_url( '/' )); ?>" method="get">
                    ...
                    <input placeholder="<?php echo esc_attr( $search_form_input_placeholder ?: __( 'Search here...', 'widgetkit-for-elementor' ) ); ?>" type="text" name="s" id="search" value="<?php the_search_query(); ?>" />
                    <input type="submit" id="searchsubmit" value="<?php echo esc_attr( $search_form_input_button_text ?: __( 'Search', 'widgetkit-for-elementor' ) ); ?>" />
                </form>
            </div>
        </div>
    </div><!-- animation-text -->
