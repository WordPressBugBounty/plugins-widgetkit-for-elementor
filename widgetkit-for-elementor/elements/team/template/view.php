...
<div class="wk-team">
        ...
        <div class="wk-card wk-card-default wk-style-1">
            <div class="wk-card-media-top wk-overflow-hidden">
                <?php if ($team['single_content_link']) : ?>
                    <a class="wk-display-block wk-text-center" href="<?php echo esc_url($team['single_content_link']['url']); ?>" <?php echo esc_attr($team['single_content_link']['is_external']) ? 'target="_blank"' : '"rel="nofollow"'; ?>>
                        ...
                        <div class="wk-width-auto social-icons">
                            <?php foreach ($team['social_share'] as $social) : ?>
                                <?php if ($social['social_link']['url']) : ?>
                                    <a href="<?php echo esc_url($social['social_link']['url']); ?>" <?php echo esc_attr($social['social_link']['is_external']) ? 'target="_blank"' : '"rel="nofollow"'; ?>>
    ...
    <?php elseif ($team['item_styles'] == 'screen_2') : ?>
        <div class="wk-card wk-card-default wk-style-2">
            <div class="wk-card-media-top wk-overflow-hidden">
                <?php if ($team['single_content_link']) : ?>
                    <a class="wk-display-block" href="<?php echo esc_url($team['single_content_link']['url']); ?>" <?php echo esc_attr($team['single_content_link']['is_external']) ? 'target="_blank"' : '"rel="nofollow"'; ?>>
                        <?php if (!empty($team['single_image']['id'])) {
                            echo wp_get_attachment_image($team['single_image']['id'], 'full', false, ['alt' => '']);
                        } elseif (!empty($team['single_image']['url'])) {
                            // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
    ...
    <?php elseif ($team['item_styles'] == 'screen_6') : ?>
        ...
        <div class="wk-card wk-style-6">
            <div class="wk-card-wrapper">
                <a class="wk-display-block wk-card-link" href="<?php echo esc_url($team['single_content_link']['url']); ?>" <?php echo esc_attr($team['single_content_link']['is_external']) ? 'target="_blank"' : '"rel="nofollow"'; ?>>
