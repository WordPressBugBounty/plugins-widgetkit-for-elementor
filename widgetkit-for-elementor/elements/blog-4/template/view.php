...
<div id=" <?php echo esc_attr($id); ?>" class="tgx-blog-4">
    <div class="row">
        ...
        ?>
                ...
                <?php if (has_post_thumbnail()) : ?>
                    ...
                    <div class="col-md-<?php echo esc_attr($settings['blog_4_layout_item_show']); ?>">
                        ...
                        background: url('<?php echo esc_attr($backgroundImg[0]); ?>');
                                    ...
                                    <div class="data">
                                        <div class="content">
                                            ...
                                            <?php if ($settings['blog_4_meta_enable'] == 'yes') : ?>
                                                ...
                                                <label for="show-menu-<?php echo esc_attr($i); ?>" class="menu-button">
                                                    <span></span>
                                                </label>
                                        </div> <!-- content -->


                                        <input type="checkbox" id="show-menu-<?php echo esc_attr($i); ?>" />
                                        <ul class="menu-content">
                                            <li>
                                                <a href="<?php the_permalink(); ?>" class="fa fa-bookmark-o"></a>
                                            </li>
                                            <?php $count_posts = wp_count_posts(); ?>
                                            <li><a href="<?php the_permalink(); ?>" class="fa fa-eye"><span><?php echo esc_html($count_posts->publish); ?></span></a></li>
